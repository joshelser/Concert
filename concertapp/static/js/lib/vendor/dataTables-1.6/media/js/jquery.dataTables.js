	...
	$.fn.dataTable = function( oInit )
	{
		...
		function _fnAddOptionsHtml ( oSettings )
		{
			...
			for ( var i=0 ; i<aDom.length ; i++ )
			{
				...
				{
				    /* A pre-existing element is being specified */
				    insertNodeID = '';
				    while (cNext != "'" || cNext != '"' )
				    {
				        insertNodeID += cNext;
				    ...
				    /* Insert ID has been found */
				    var insertNode = document.getElementById(insertNodeID);
				    
				    /* Advanced past closing '@' */
				    i += 1;
				    alert('@found');
				}
				else if ( cOption == '>' )
